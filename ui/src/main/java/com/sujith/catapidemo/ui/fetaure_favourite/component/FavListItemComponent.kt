package com.sujith.catapidemo.ui.fetaure_favourite.component
        ...
        Box(
            ...
            Row(
                ...
                Text(
                    ...
                    fontSize = dimensionResource(R.dimen.small_medium_font_size).value.sp,
                    color = Color.White,
...
@Composable
fun FavListItemComponentPreview() {
    Surface {
